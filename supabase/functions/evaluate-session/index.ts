...
{
  "communication": <1-10 score based on clarity and articulation >,
    "grammarUsage": <1-10 score based on grammatical correctness >,
      "leadership": <1-10 score based on guiding discussion >,
        "confidence": <1-10 score based on assertiveness >,
          "initiative": <1-10 score based on how often the user started a point within the 5s window >,
            "listeningAbility": <1-10 score based on how well they built on AI participant points >,
              "topicAccuracy": <1-10 score based on staying relevant to the topic: "${topic}" >,
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          { role: "user", content: "Evaluate the session objectively based on the transcripts and return the JSON evaluation." }
        ],
        max_tokens: 1000,
